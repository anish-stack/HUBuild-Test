...
const StepWizard = () => {
    ...
    const handleFetchmembership = async () => {
        try {
            const { data } = await axios.get("http://localhost:5654/api/v1/get_all_membership");
    ...
    const fetchCurrentLocation = async () => {
        try {
            const res = await axios.post("http://localhost:5654/Fetch-Current-Location", {
                lat: coords.latitude,
    ...
    const handlePayment = async (providerId) => {
        try {
            ...
            const res = await axios.post(`http://localhost:5654/api/v1/buy_membership/${providerId}`, {
            ...
            if (order) {
                const options = {
                    ...
                    order_id: order.id,
                    // callback_url: "http://localhost:5654/api/v1/membership_payment_verify",
                    handler: async function (response) {
                        // This runs on successful payment
                        try {
                            const { data } = await axios.post("http://localhost:5654/api/v1/membership_payment_verify", {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("http://localhost:5654/api/v1/register-provider", memberData);
    ...
    const handleCheckCouponCode = async (code = null) => {
        ...
        try {
            const res = await axios.post("http://localhost:5654/api/v1/check_coupon_code", {
