...
const EditCustomChat = () => {
    ...
    const handleFetchSingleCustomChat = async () => {
        try {
            const { data } = await axios.get(`https://helpapi.nypers.in/api/v1/get-chat-by-id/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.put(`https://helpapi.nypers.in/api/v1/manual-chat-room/${id}`, {
                ...
                <div className="provider-card-header">
                    <div className="d-flex justify-content-between align-items-center">
                        <h6 className="mb-0 fw-bold">
                            ...
                            {categoryDisplayNames[category]} Providers
                        </h6>
                                                ...
                                                >
                                                    ...
                                                    <td>
                                                        {provider.location ? (
                                                            ...
                                                            <span className="provider-detail">No location</span>
                                                        )}
                                                    </td>
                                                </tr>
                                            );
